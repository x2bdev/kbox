...
//        $generalConfig['fe_name_shop'] = 'Phương Nghi Shop';
...
//            $listId = array_keys($dataCart);
//            $products = $this->productRepository->getProductByListIdOnSite($listId);
//            $arrProductInCart = array();
//
//            foreach ($dataCart as $key => $value) {
//                $arrProductInCart = array_merge($arrProductInCart, $value);
//            }
//            $totalBill = 0;
//
//
//            // Info Order
//            $xhtml_order = '<h2 style="text-align:left;margin:10px 0;border-bottom:1px solid #ddd;padding-bottom:5px;font-size:13px;color:#ff6a00">CHI TIẾT ĐƠN HÀNG</h2>';
//            $xhtml_order .= '<table cellspacing="0" cellpadding="0" border="0" width="100%" style="background: #f5f5f5;max-width: 730px">';
//            $xhtml_order .= '<thead>';
//            $xhtml_order .= '<tr>';
//            $xhtml_order .= '<th align="left" bgcolor="#ff6c6c" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Tên sản phẩm</th>';
//            $xhtml_order .= '<th align="center" bgcolor="#ff6c6c" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px;width:120px">Giá tiền</th>';
//            $xhtml_order .= '<th align="left" bgcolor="#ff6c6c" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Số lượng</th>';
//            $xhtml_order .= '<th align="right" bgcolor="#ff6c6c" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px;width:120px">Thành tiền</th></tr></thead>';
//
//            foreach ($arrProductInCart as $key => $value) {
//
//                $billId = $newBill->id;
//                $productId = $value['id'];
//                $size = $value['size'];
...
//                ];
//
//                $htmlAttribute = "<div>Size: " . $dataDetail['size'] . " - Màu: " . $dataDetail['color'] . "</div>";
//
//                $xhtml_order .= '<tbody bgcolor="#eee" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px">';
//                $xhtml_order .= '<tr>';
//                $xhtml_order .= "<td align='left' valign='top' style='padding:3px 9px'>" . $products[$productId]->name . " <em>" . $htmlAttribute . "</em></td>";
...
//                        <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:3px solid #ff6a00;padding-bottom:10px;background-color:#fff">
//                            <tbody>
//                                <tr>
//                                    <td valign="top" bgcolor="#FFFFFF" width="100%" style="padding:0">
//                                        <a style="border:medium none;text-decoration:none;color:#ff6a00;margin:0px 120px 0px 20px" href="#" target="_blank" >
//                                        <img src="' . $logo . '" width="260px" height="50px" style="margin-top: 20px"/>
//                                        </a>
//                                        <a style="border:medium none;text-decoration:none;color:#ff6a00" href="#" target="_blank">
//                                        </a>
//                                    </td>
//                                </tr>
//                            </tbody>
...
//                                        </p>
//                                        <h3 style="font-size:13px;font-weight:bold;color:#ff6a00;text-transform:uppercase;margin:20px 0 0 0;border-bottom:1px solid #ddd">
...
//                                            <a href="mailto:' . $generalConfig['fe_email_cskh'] . '" style="color:#ff6a00;text-decoration:none" target="_blank">
//                                            <strong>' . $generalConfig['fe_email_cskh'] . '</strong>
//                                            </a>, hoặc gọi số điện thoại
//                                            <strong style="color:#ff6a00">' . $generalConfig['fe_phone_top'] . '</strong> (8-21h cả T7,CN). Đội ngũ ' . $generalConfig['fe_name_shop'] . ' luôn sẵn sàng
...
//                                            <strong>
//                                            <a style="color:#ff6a00;text-decoration:none;font-size:14px" href="#">' . $generalConfig['fe_name_shop'] . '</a>
//                                            </strong>
//                                            <br>
//                                        </p>
//                                    </td>
