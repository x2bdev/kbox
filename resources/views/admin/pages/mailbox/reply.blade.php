                ...
                <div class="x_content">
                    ...
                    <!-- /MAIL LIST -->
                        ...
                        <div class="col-sm-9 mail_view">
                            ...
                            {!! Form::open(['method' => 'POST' ,'id' => 'form' ,'url' => route('mailbox.sendReply')]) !!}
                                    ...
                                    <div class="x_content">
                                        <div class="form-group">
                                            <label style="margin-top: 5px" class="col-md-2 control-label text-right">Trả
                                                lời đến </label>
                                            <div class="col-md-10">
                                                {!! Form::text('toEmail', $data_one->email, array('class' => 'form-control','readonly'=>'readonly')) !!}
                                            </div>
                                        </div>
                                        <div style="margin-top: 10px" class="form-group">
                                            <label style="margin-top: 5px" class="col-md-2 control-label text-right">Chủ
                                                đề </label>
                                            <div class="col-md-10">
                                                {!! Form::text('subject','', array('class' => 'form-control', 'placeholder' => 'Nhập chủ đề email')) !!}
                                            </div>
                                        </div>
                                        <div style="margin-top: 10px" class="form-group">
