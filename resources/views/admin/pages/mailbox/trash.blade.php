                        ...
                        <div class="col-sm-9 mail_view">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Danh sách thư đã xóa</h3>
                                </div>
                                <div class="panel-body">
                                    <div>
                                        ...
                                        <div class="btn-group">
                                            <button type="button" id="delete-trash" class="btn btn-default btn-md"><i
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($data_table as $key => $value)
                                            ...
                                            <tr class="{{ $value->id }}">
                                                ...
                                                <td>
                                                    <a href="{{ route('mailbox.show',$value->id)  }}">{{ $value->subject }}</a>
                                                </td>
                                                <td>
                                                    {{ $value->full_name }}
                                                </td>
    ...
    <script>
        $(document).ready(function () {
            ...
            delete_trash.click(function () {
                bootbox.confirm({
                    message: "Bạn đã chắc chắn xóa thư này?",
                    buttons: {
                        confirm: {
                            label: 'Đồng ý',
