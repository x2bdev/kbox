                                ...
                                @foreach ( $partners as $partner )
                                    <tr class="pointer">
                                        <td class="a-center td-content">
                                            <input type="checkbox" class="flat" name="table_records" value="{{$partner->id}}">
                                        </td>
                                        ...
                                        <td class="td-content gallery-rebox">
                                            <a href="{{ asset('public/upload/images/partner/' . $partner->image) }}">
                                                <img alt="{{ $partner->name  }}" src="{{ asset('public/upload/images/partner/75x50/' . $partner->image) }}" class="thumb"/>
                                            </a>
                                        </td>
                                        <td class="td-content">
                                            <?php $labelStatus = ($partner->type == 0) ? 'success' : 'warning'; ?>
                                            <button type="button" class="btn btn-<?php echo $labelStatus; ?> btn-xs">
                                                <?php echo ($partner->type == '0') ? "Normal" : "Slide";?>
                                            </button>
                                        </td>
                                        <td class="td-content">
                                        ...
                                        <td class="td-content" role="gridcell" aria-describedby="jqgrid_act">
                                            <a href="{{route('banner.confirm', $partner->id)}}" class="btn btn-info btn-xs"
