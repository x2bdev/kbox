...
@section('content')
    <section id="widget-grid" class="">
        {!! Form::open(array(
            ...
            'method' => 'post',
            'url'=> route('partner.confirm', $data->id)
        )) !!}
        ...
        <div class="row">
                        ...
                        <div id="old" class="tab-pane fade {{ $class['old'] }}">
                            <div class="x_content">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tên đối tác<span
                                                class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::text('name', $data->name, array('class' => 'form-control', 'placeholder' => 'Tên đối tác')) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="x_content">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tên đối tác<span
                                                class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::text('name', $dataNew['name'], array('class' => 'form-control', 'placeholder' => 'Tên đối tác')) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-3">
                @php
                    ...
                    $id = $data->id;
                @endphp
                @include('admin.blocks.box.confirm',['route_cancel'=> route('partner.confirmActionCancel', $data->id), 'route_apply'=> route('partner.confirmActionApply', $data->id)])
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Tình trạng</h2>
                        <ul class="nav navbar-right panel_toolbox">
                ...
                @if($dataNew['image'] !== null)
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="form-group">
                                <img id="imagePreview"
                                     src="{{ asset('public/upload/images/partner/' . $dataNew['image']) }}"
                                     alt="image preview"
                                     style="width: 100%"/>
                            </div>
                        </div>
