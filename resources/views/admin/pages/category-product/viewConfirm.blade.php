...
@section('content')
    <section id="widget-grid" class="">
        {!! Form::open(array(
            ...
            'method' => 'post',
            'url'=> route('category-product.confirm', $data->id)
        )) !!}
        ...
        <div class="row">
                            ...
                            <div class="x_content">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        ?>
                                        {!! Form::text('category', $categoryNameOld, array('class' => 'form-control', 'placeholder' => '', 'readonly'=>'readonly')) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        {!! Form::text('slug', $data->slug, array('class' => 'form-control', 'placeholder' => '', 'readonly'=>'readonly')) !!}
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="col-md-3">
                @php
                    ...
                    $id = $data->id;
                @endphp
                @include('admin.blocks.box.confirm',['route_cancel'=> route('category-product.confirmActionCancel', $data->id), 'route_apply'=> route('category-product.confirmActionApply', $data->id)])
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Tình trạng</h2>
                        <ul class="nav navbar-right panel_toolbox">
